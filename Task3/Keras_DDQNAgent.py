...
from custom_DRL_models import default_model_v1, default_model_v2, cnn_model_v1, cnn_model_v2
...
class Keras_DDQNAgent:
    ...
    def _build_model(self):
        return default_model_v2(input_shape=(15,15,1), action_size=self.action_size)
